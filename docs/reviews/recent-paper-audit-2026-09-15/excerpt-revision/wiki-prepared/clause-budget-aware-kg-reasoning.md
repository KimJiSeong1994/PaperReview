---
title: "CLAUSE — 지식 그래프의 맥락 구성을 학습해 정확도와 비용을 함께 조절하다"
slug: clause-budget-aware-kg-reasoning
excerpt: "CLAUSE는 지식 그래프의 편집·경로 탐색·근거 선택을 세 정책으로 공동 학습해 정확도와 자원 비용을 조절한다. 저자 실험에서 질의응답 정확도와 일부 효율 지표가 개선됐지만, 학습된 비용 제약만으로 모든 질의의 예산 준수가 보장되지는 않는다."
category: AI Agents
tags:
  - clause
  - knowledge-graph
...
date: "2026-09-06"
venue: "ICLR 2026"
paper_version: "ICLR 2026 conference proceedings PDF, 27 pages"
source_paper: "https://proceedings.iclr.cc/paper_files/paper/2026/file/8598c5d05e1d045919962e430b0bdf0d-Paper-Conference.pdf"
thumbnail: "figures/clause-fig1-workflow.png"
reviewed_at: "2026-09-15"
updated_at: "2026-09-15T14:10:12.721107+00:00"
blog_url: "https://jiphyeonjeon.kr/blog/clause-budget-aware-kg-reasoning"
---

# CLAUSE — 지식 그래프의 맥락 구성을 학습해 정확도와 비용을 함께 조절하다
...
[![CLAUSE의 Architect, Navigator, Curator와 중앙 task 및 cost critic의 연결 구조](figures/clause-fig1-workflow.png)](figures/clause-fig1-workflow.png)
...
[![HotpotQA, FactKG, MetaQA에서 no-RAG, RAG 계열, agent 계열과 CLAUSE의 정규화 토큰 사용 비교](figures/clause-fig2-token-consumption.png)](figures/clause-fig2-token-consumption.png)
...
[![MAPPO, Fixed-Penalty PPO, RCPO, LC-MAPPO의 feasibility와 지연 위반·비용·dual 값 비교](figures/clause-fig3-constraint-satisfaction.png)](figures/clause-fig3-constraint-satisfaction.png)
...
[![Brian Backer를 anchor로 잡고 그래프 경로를 탐색한 뒤 공동 출연 배우와 영화 관계를 구성한 사례](figures/clause-fig4-case-study.png)](figures/clause-fig4-case-study.png)
