...
**Paper:** Jinyang Wu; Shuo Yang; Zhengxi Lu; Fan Zhang; Yuhao Shen; Lang Feng; Haoran Luo; Zheng Lian; Shuai Zhang; Zhengqi Wen; Jianhua Tao (2026). "SEED: Self-Evolving On-Policy Distillation for Agentic Reinforcement Learning". https://arxiv.org/abs/2607.14777 · arXiv:2607.14777v1
...
모든 baseline을 포함하면 평가는 조금 달라진다. 저자들이 static distillation 계열로 묶은 평가 구현들과의 12개 aggregate 비교 중 SEED는 9개에서 best 또는 tied-best다. Qwen2.5-3B Search 평균에서도 SEED 45.7은 Skill-SD 47.8보다 낮다. Qwen2.5-7B의 Search 평균 48.6은 RLSD·SDAR의 49.0보다 낮고, WebShop success 78.1도 SDAR 82.8보다 낮다. SEED가 강한 결과를 보였다는 평가와 모든 셀을 지배했다는 평가는 구분해야 한다.
...
Vision extension에서는 Sokoban 67.1→82.0, EZPoints 86.9→100.0으로 평균이 77.0에서 91.0으로 올랐다(Table 8). Text-only를 넘어선 가능성을 보여 주지만, 두 benchmark만으로 일반적인 multimodal agentic RL까지 입증했다고 보기는 어렵다. ---
