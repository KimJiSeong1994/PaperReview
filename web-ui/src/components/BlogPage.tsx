  ...
  const renderDetail = () => {
    ...
    return (
      <div className="blog-detail">
        ...
        >
          {selectedPost.thumbnail_url ? (
            <img src={selectedPost.thumbnail_url} alt={selectedPost.title} />
          ) : (
            <span className="blog-detail-thumb-placeholder" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" width="64" height="64" style={{ opacity: 0.3 }}>
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                <polyline points="14 2 14 8 20 8" />
              </svg>
            </span>
