...
# ── Topology analysis parameters (Phase 3) ─────────────────────────
TOPOLOGY_HUB_PERCENTILE = 90
TOPOLOGY_COMMUNITY_MIN_SIZE = 3
TOPOLOGY_PAGERANK_ALPHA = 0.85
TOPOLOGY_USE_IGRAPH_THRESHOLD = 5000
